.class Lcom/kunlun/platform/android/KunlunConf$x;
...
.method final A()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.sdk.api.koramgame.com/?act=webpage.main&deviceType=android"
...
.method final n()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.login.koramgame.com/?act=user.phonelogin"
...
.method final o()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.login.koramgame.com/?act=user.phoneregist"
...
.method final p()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.login.koramgame.com/?act=user.phoneconversion&v=2.0"
...
.method final q()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.login.koramgame.com/?act=user.phonechangepwd&v=2.0"
...
.method s()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.mcenter.koramgame.co.kr/"
...
.method final u()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.koramgame.com/?act=mobilenew.main&deviceType=android"
...
.method final w()Lcom/kunlun/platform/android/KunlunConf$T;
    .locals 1

    const-string v0, "http://www.koramgame.com/?act=mobilenew.payhistory&deviceType=android"
...
.method final x()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.login.koramgame.com/?act=user.facebooklogin"
...
.method final y()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.login.koramgame.com/?act=user.thirdpartylogin"
...
.method final z()Lcom/kunlun/platform/android/KunlunConf$T;
    ...
    const-string v0, "http://kr.koramgame.com/?act=mobile.login&deviceType=android"
